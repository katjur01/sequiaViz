...
server = function(input, output, session) {
  ...
  observeEvent(input$addBamLocalFileButton, {
    ...
    if(file.exists("./input_files/MOII_e117/primary_analysis/230426_MOII_e117_fuze/mapped/DZ1601fuze.bam")){
      print("I can see. this bam file")
      bamFile <- "./input_files/MOII_e117/primary_analysis/230426_MOII_e117_fuze/mapped/DZ1601fuze.bam"
    }
    x <- readGAlignments(bamFile, param = Rsamtools::ScanBamParam(what="seq"))
    loadBamTrackFromLocalData(session, id="igvShiny_0", trackName="./input_files/MOII_e117/primary_analysis/230426_MOII_e117_fuze/mapped/DZ1601fuze.bam", data=x)
  })
